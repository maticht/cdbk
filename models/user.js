...
const userSchema = new mongoose.Schema({
    ...
    additionalImage1: {type: String, required: false},
    additionalImage2: {type: String, required: false},
    additionalImage3: {type: String, required: false},
    additionalImage4: {type: String, required: false},
    additionalImage5: {type: String, required: false},
    additionalImage6: {type: String, required: false},
    additionalImage7: {type: String, required: false},
    additionalImage8: {type: String, required: false},
    additionalImage9: {type: String, required: false},
    additionalImage10: {type: String, required: false},
...
const validate = (data) => {
    const schema = Joi.object({
        ...
        image: Joi.string().required().label("ImageURL").options({ allowUnknown: true }),
        additionalImage1: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage2: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage3: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage4: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage5: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage6: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage7: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage8: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage9: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
        additionalImage10: Joi.string().required().label("Image URL").options({ allowUnknown: true }),
    });
